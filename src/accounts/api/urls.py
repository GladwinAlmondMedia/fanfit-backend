...
urlpatterns = [
	...
	url(r'^update/profile/(?P<id>\d+)/activity/(?P<activity_id>\d+)/$', UpdateUserProfileAPIView.as_view(), name='update-profile'),
	...
	url(r'^update/photo/(?P<id>\d+)/$', UpdatePhotoAPIView.as_view(), name='update-photo'),
]